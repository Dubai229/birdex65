 ...
 *  - цена курицы окупается от ~5 ч (Рыжая) до ~150 ч (Золотая).
 */
function hen(
...
export const CHICKENS: ChickenDefinition[] = [
  ...
  hen(32, 'hen_32', 'Самурайская', 'legendary', 63_000, 31_000_000, 64),
  hen(33, 'hen_33', 'Космическая', 'legendary', 77_000, 43_000_000, 111),
  hen(34, 'hen_34', 'Радужная', 'legendary', 94_000, 57_000_000, 158),
  hen(35, 'hen_35', 'Алмазная', 'legendary', 110_000, 74_000_000, 205),
  hen(36, 'golden_hen', 'Золотая', 'legendary', 130_000, 97_000_000),
]
